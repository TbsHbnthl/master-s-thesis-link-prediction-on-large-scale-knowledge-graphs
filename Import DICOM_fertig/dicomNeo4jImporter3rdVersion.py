...
def print_static(static_nodes, static_type):
    ...
    export_nodes_to = '/Users/tobias/Library/Mobile Documents/com~apple~CloudDocs/Documents/Uni/Masterarbeit/Datengrundlage/Cancer Imaging Archive/Import3rd/nodes'
...
for elem in paths:
    ...
    for file in listOfFiles:
        ...
        if file.endswith('.dcm'):
            ...
            relationID_without_prov = str(ds[0x013,0x1010].value) + str(file) + 'hasFile'
            if relationID_without_prov not in relations_with_provenances:
            ...
            relationID_without_prov = str(ds[0x013,0x1010].value) + str(ds['PatientID'].value) + 'hasPatient'
            if relationID_without_prov not in relations_with_provenances:
...
def print_edges(edges_to_print, edgeType):
    ...
    # create new dir if necessary
    export_nodes_to = '/Users/tobias/Library/Mobile Documents/com~apple~CloudDocs/Documents/Uni/Masterarbeit/Datengrundlage/Cancer Imaging Archive/Import3rd/relations'
...
def print_variable_node_headers(var_node):
    ...
    temp_dir = '/Users/tobias/Library/Mobile Documents/com~apple~CloudDocs/Documents/Uni/Masterarbeit/Datengrundlage/Cancer Imaging Archive/Import3rd/CSVHeaderFiles/nodes'
...
def print_variable_edge_headers(edge_type):
    temp_dir = '/Users/tobias/Library/Mobile Documents/com~apple~CloudDocs/Documents/Uni/Masterarbeit/Datengrundlage/Cancer Imaging Archive/Import3rd/CSVHeaderFiles/relations'
...
def print_additional_provenances():
    temp_dir = '/Users/tobias/Library/Mobile Documents/com~apple~CloudDocs/Documents/Uni/Masterarbeit/Datengrundlage/Cancer Imaging Archive/Import3rd'
